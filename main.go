...
func main() {
	...
	flag.IntVar(&spec.NumKvMounts, "num_kv_mounts", 1, "number of different K/V mounts to use")
	...
	flag.IntVar(&spec.NumApproleMounts, "num_approle_mounts", 1, "number of different AppRole mounts to use")
	...
	flag.IntVar(&spec.NumPkiMounts, "num_pki_mounts", 1, "number of different PKI mounts to use")
