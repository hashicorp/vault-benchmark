...
// Override flags
var PctLDAPLogin = flag.Int("pct_ldap_login", 0, "percent of requests that are LDAP logins")
...
// Constants for test
const LDAPAuthTestMethod = "POST"
const LDAPAuthConfigTag = "ldap_auth_config"
